...
export function DashboardHome() {
  ...
  const totalRevenue = sales.reduce((acc, sale) => acc + sale.car.price, 0);

  const stats = [
    { title: 'Total Cars', value: cars.length, icon: Car, color: 'bg-blue-500', trend: '+12%' },
    { title: 'Available Cars', value: availableCars, icon: Car, color: 'bg-green-500', trend: '+8%' },
    { title: 'Sold This Month', value: soldCars, icon: ShoppingCart, color: 'bg-purple-500', trend: '+23%' },
    { title: 'Total Revenue', value: formatCurrency(totalRevenue), icon: DollarSign, color: 'bg-amber-500', trend: '+18%' },
    { title: 'Active Customers', value: customers.length, icon: Users, color: 'bg-indigo-500', trend: '+5%' },
    { title: 'Gallerists', value: gallerists.length, icon: Users, color: 'bg-pink-500', trend: '0%' },
  ];
